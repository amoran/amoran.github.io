...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBash = __webpack_require__(188);

	var _reactBash2 = _interopRequireDefault(_reactBash);
	...
	var open = exports.open = {
		exec: function exec(_ref, command) {
	...
	var App = function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				var extensions = { open: open };
				return _react2.default.createElement(
					'div',
					{ className: 'pageWrapper' },
					_react2.default.createElement(
						'div',
						{ className: 'terminalWrapper' },
						_react2.default.createElement(_reactBash2.default, {
							extensions: extensions,
							history: [{ value: 'Welcome!' }],
							prefix: 'guest@amoran.github.io',
							structure: _constants.structure
						})
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _component = __webpack_require__(189);
	...
	var _const = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commands = __webpack_require__(190);

	var BaseCommands = _interopRequireWildcard(_commands);

	var _bash = __webpack_require__(193);
...
/***/ function(module, exports) {
	...
	var structure = exports.structure = {
	    code: {
	        'Readme.md': {
	            content: 'Type help to list all commands.'
	        },
	        'trecipes': {
	            file: {
	                'Readme.md': 'This is the text content for Readme in Trecipes'
	            }
	        },
	        'andy-rover': {
	            file: {
	                'Readme.md': 'This is the text content for Readme in andy-rover'
	            }
	        },
	        'groupme-insult-bot': {
	            file: {
	                'Readme.md': 'This is the text content for Readme in groupme-insult-bot'
	            }
	        }
	    },
	    '.contact': { content: 'You can email me at amorancs@gmail.com' }
	};
